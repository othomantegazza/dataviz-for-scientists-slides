...
- [MDN web docs](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Introduction). An introdution to web development by the Mozilla Foundation.
...
Although it might be fun sometimes.
