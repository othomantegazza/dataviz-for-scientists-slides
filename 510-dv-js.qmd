...
Open this [JS Fiddle](https://jsfiddle.net/othomantegazza/tk394a5n/89/) that makes a bar chart out of an excel table, from data on the population of italian cities.

- Change the color of the bars.
- Add curved round the corner of the bars rectangles.
- Add a new bar with the fourth highest populated city.
- Arrange the bars from smaller to the bigger.
- Color in yellow only the bar that shows data about Milan.
