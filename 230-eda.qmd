...
## Exercise - Put On Your Detective Hat

:::: {.columns}

::: {.column width="45%"}

Someone hid three secret messages in this dataset.

Explore their content graphically to find them.

The aim of this exercise is to let you practice making many exploratory graphs.
...
- Do not waste your time refining the axis labels, refining your style. As long as you understand what's in those graph, they are good enough.

Show the data, the patterns are often hidden in details.
