...
Use this [online markdown editor](https://markdownlivepreview.com/) to reproduce (by copying abd pasting) the main content of [R for Data Science's Chapter on Quarto](https://r4ds.hadley.nz/quarto). 
