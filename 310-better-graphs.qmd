...
Even if bars have an area that is directly proportional to the values in the data, when we use a barolot, we are map the data to the length of the bars, not to the area. Otherwise we could not represent negative values.
:::
