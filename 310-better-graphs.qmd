...
![](img/retinal-v-color-categorical.png){.absolute top=70 left=500 style="z-index: -1;"}
...
![](img/retinal-variables-colours-1.png){.absolute top=70 left=500 style="z-index: -1;"}
...
![](img/shapes-examples.png){.absolute top=0 left=500 style="z-index: -1;"}
...
They can't be used for quantitative data. They could be used for ordered categorical data, but I'd advise against this practice.
...
![](img/retinal-shapes.png){.absolute top=0 left=500 style="z-index: -1;"}
...
Linear size and area are widely mapped to quantitative values, such as absolute measurements and percentages.
